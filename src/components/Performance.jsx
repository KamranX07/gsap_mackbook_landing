    ...
    return (
        <section id="performance" ref={sectionRef}>
            ...
            <div className="content">
                <p>
                    Run graphics-intense workflows with a responsiveness that keeps up with your imagination. The M4 family of chips features a GPU with a second-generation hardware-accelerated ray tracing engine that renders images faster, so
